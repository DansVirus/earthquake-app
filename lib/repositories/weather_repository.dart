...
///Repository is a class that is solely responsible for fetching data from a datasource
///in the architectural pattern.
class WeatherRepository {
  ...
  Future<EarthquakeModel> getEarthquakeData(QueryParams queryParams) async {
    final uri =
        Uri.https(baseUrl.authority, baseUrl.path, queryParams.toJson());
